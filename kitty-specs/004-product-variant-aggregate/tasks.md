...
| T002 | Implement StockReservation VO (types + factory) | WP01 | |
| T003 | Implement domain event types (StockReserved, StockReleased, StockDepleted) | WP01 | |
| T004 | Implement ProductVariant types | WP01 | |
...
| T012 | Export public API from index.ts | WP01 | |
