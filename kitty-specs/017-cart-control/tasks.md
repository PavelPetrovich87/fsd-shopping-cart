...
|---|---|---|---|---|
| T001 | Write `cart-control.stories.tsx` — Default, AtMinimum, AtMaximum, Disabled, Interaction stories | WP01 | ✓ | None |
| T002 | Implement `cart-control.tsx` — component with Plus/Minus buttons, quantity display, a11y | WP01 | ✓ | T001 |
| T003 | Create `index.ts`, export from `shared/ui/index.ts` | WP01 | ✓ | T002 |
| T004 | Validate: `npm run lint`, `npm run lint:arch`, `npm run build`, `npm run test:storybook` | WP01 | ✓ | T002, T003 |
